...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-800 bg-pharos-dark/95 backdrop-blur">
      <div className="container mx-auto flex h-14 items-center justify-between px-4">
        <Link href="/" className="flex items-center gap-2 font-semibold text-white">
          <span className="gradient-text text-lg">QHDA</span>
          <span className="hidden text-slate-400 sm:inline">Quantum-Hybrid DEX Accelerator</span>
        </Link>
